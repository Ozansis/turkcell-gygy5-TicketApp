...
//Google'ın modern anahtar-değer deposu.
// Eski SharedPreferences'ın yerini aldı.
// Telefonda auth_prefs adında küçük bir dosya oluşturuyor, içine key-value çiftleri yazıyor.
private val Context.authDataStore by preferencesDataStore(name = "auth_prefs")

// Kullanıcı giriş yaptığında sunucudan gelen accesToken ve refreshToken cihazın kalıcı deposunda depolanacaks.

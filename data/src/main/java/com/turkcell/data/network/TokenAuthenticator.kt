...
// OkHttp'nin Authenticator interface'ini implement ediyor. Çalışma mantığı şu:
//
//  Uygulama bir API isteği attı. Sunucu 401 döndü — "bu token geçersiz." OkHttp normalde isteği başarısız sayar ve bırakır.
//  Ama Authenticator tanımlıysa önce ona sorar: "Ne yapayım?"
//
//  TokenAuthenticator şunu yapacak: refreshToken'ı alıp sunucuya /auth/refresh isteği at
//  , yeni accessToken al, cihaza kaydet, orijinal isteği yeni token ile tekrar dene.
//
//  Şu an return null — henüz tamamlanmamış, ileride doldurulacak.